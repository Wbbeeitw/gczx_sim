        ...
        if stage == STAGE_PREPARE_DATA:
            ...
            train_zp_head(
                ZPTrainingConfig(
                    ...
                    window_size=cfg.zp.window_size,
                    num_layers=cfg.zp.num_layers,
                    num_heads=cfg.zp.num_heads,
                    ffn_dim=cfg.zp.ffn_dim,
                    stage_embedding_dim=cfg.zp.stage_embedding_dim,
                    progress_hidden_dim=cfg.zp.progress_hidden_dim,
                    progress_depth=cfg.zp.progress_depth,
                    ...
                    phase_loss_weight=cfg.zp.phase_loss_weight,
                    progress_loss_weight=cfg.zp.progress_loss_weight,
                    global_progress_loss_weight=cfg.zp.global_progress_loss_weight,
                    label_smoothing=cfg.zp.label_smoothing,
                    use_class_weights=cfg.zp.use_class_weights,
                    progress_beta=cfg.zp.progress_beta,
                    max_grad_norm=cfg.zp.max_grad_norm,
                    stage_only_epochs=cfg.zp.stage_only_epochs,
                    gt_stage_prior_epochs=cfg.zp.gt_stage_prior_epochs,
                    stage_prior_ramp_epochs=cfg.zp.stage_prior_ramp_epochs,
                    max_pred_stage_prior_weight=cfg.zp.max_pred_stage_prior_weight,
                    device=cfg.train.device,
                    seed=cfg.train.seed,
                )
            )
            ...
            summary = train_cfg_from_advantages(
                DownstreamCFGTrainingConfig(
                    ...
                    unconditional_prob=cfg.cfg_train.unconditional_prob,
                    negative_guidance_scale=cfg.cfg_train.negative_guidance_scale,
                    csa_positive_quantile=cfg.cfg_train.csa_positive_quantile,
                    csa_bottom_quantile=cfg.cfg_train.csa_bottom_quantile,
