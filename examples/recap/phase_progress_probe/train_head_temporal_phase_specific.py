...
"""Train a temporal phase-specific z/p head on cached frozen features."""
...
from model_temporal_phase_specific import TemporalPhaseSpecificProgressHead
...
def _compute_metrics(
    ...
    """Compute validation metrics for the temporal phase-specific head."""
...
@torch.no_grad()
def evaluate(
    head: TemporalPhaseSpecificProgressHead,
    ...
    """Evaluate the temporal phase-specific head on one split."""
    head.eval()
    total_loss = 0.0
    total_samples = 0
...
def train(
    ...
    """Train the temporal phase-specific head and return best validation info."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output_dir",
        default="/workspace/results/phase_progress_probe/head_temporal_phase_specific",
    )
    ...
    torch.save(
        {
            ...
            "head_type": "temporal_phase_specific_progress",
        },
        output_dir / "head.pt",
    )
