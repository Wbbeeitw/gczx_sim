...
"""Base shared-MLP phase/progress head."""
...
@register_head("base_shared_mlp")
class BaseSharedMLPHead(nn.Module):
    """Lightweight shared trunk → phase classifier + progress regressor.

    This is the baseline head used in strict fusion comparisons.
    """
